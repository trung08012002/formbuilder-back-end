...
const passwordValidation = z
  ...
  .refine((value) => uppercaseRegex.test(value), { message: ERROR_MESSAGES.REQUIRED_UPPER_CASE_PASSWORD })
  .refine((value) => lowercaseRegex.test(value), { message: ERROR_MESSAGES.REQUIRED_LOWER_CASE_PASSWORD })
